var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var body = document.getElementById("particle_div");
		...
		canvas.element.style = "position: fixed; top: 0; left: 0; z-index: 0; pointer-events: none;";
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementById("particle_div").style.width;
		var height = document.getElementById("particle_div").style.height;
